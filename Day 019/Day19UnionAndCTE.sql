...
--CTE
  ...
  select top 5 * from  OrderDetails_CTE order by price desc -- will not work
...
select * from Orders
	...
	with ProductDetails_CTE(OrderID, CustomerName, ProductName)
	as 
	(select od.OrderID, c.ContactName, ProductName
	...
	select top 10 * from ProductDetails_CTE order by OrderID 
